...
\end{equation}
\begin{equation}
\vert \alpha_A\{b': \} \vert \equiv \vert \alpha_A \vert - (\vert \alpha_A \vert - k_3)
\end{equation}

By combining (1) and (3) we have
\begin{equation*}
2^{\mu_A} \vert \alpha_A\ \vert - 2^{\mu_A}(\vert \alpha_A \vert - k_3) < 2^{\mu'_B} \vert \alpha'_B \vert \Rightarrow
\end{equation*}
\begin{equation}
2^{\mu_A} \vert \alpha_A\ \vert < 2^{\mu'_B} \vert \alpha'_B \vert + 2^{\mu_A}(\vert \alpha_A \vert - k_3)
\end{equation}

Therefore we have that $2^{\mu_A} \vert \alpha_A\ \vert < 2^{\mu'_B} \vert \alpha'_B \vert$ with overwhelming probability in $k_3$, in particular as $k_3$ is the dominant factor in  $\vert \alpha_A \vert$.
